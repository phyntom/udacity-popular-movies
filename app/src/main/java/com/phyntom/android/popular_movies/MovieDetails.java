...
public class MovieDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (sentIntent.hasExtra("INTENT_MOVIE")) {
            ...
            Picasso.with(this).load("https://image.tmdb.org/t/p/w342/" + selectedMovie.getPosterPath()).resize(getResources().getInteger(R.integer.poster_size_w342_width), getResources().getInteger(R.integer.poster_size_w342_height)).into(ivPoster);
